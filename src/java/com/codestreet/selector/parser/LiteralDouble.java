 ...
 * @author Jawaid Hakim.
 */
final class LiteralDouble implements IExpressionNumeric
{
	/**
	 * Factory.
	 * 
	 ...
	 * @return Instance.
	 */
	public static synchronized LiteralDouble valueOf(final String literal)
	{
	 ...
	 *            Double literal.
	 */
	private LiteralDouble(final String literal)
	{
