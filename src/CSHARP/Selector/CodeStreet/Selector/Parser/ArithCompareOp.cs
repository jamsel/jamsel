...
namespace CodeStreet.Selector.Parser
{
	...
	/// <summary> Class to implement arithmetic comparison operators.</summary>
	/// <author>  Jawaid Hakim.
	/// </author>
	class ArithCompareOp : IExpressionNumeric
	{
		/// <summary> Ctor.</summary>
		/// <param name="op">Arithmetic comparison operator.
		/// </param>
		/// <param name="lhs">LHS.
		/// </param>
		/// <param name="rhs">RHS.
		...
		private ArithCompareOpImpl op_;
	}
}