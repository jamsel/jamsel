...
namespace CodeStreet.Selector.Parser
{
	...
	/// <summary> Class to represent a <tt>Long</tt> literal. Immutable.</summary>
	/// <author>  Jawaid Hakim.
	/// </author>
	class LiteralLong : IExpressionNumeric
	{
		...
		public static LiteralLong valueOf(System.String literal)
		{
			lock (typeof(CodeStreet.Selector.Parser.LiteralLong))
			{
				...
				LiteralLong instance = (LiteralLong) idMap_[literal];
				if (instance == null)
				{
		...
		//UPGRADE_NOTE: The initialization of  'idMap_' was moved to static method 'CodeStreet.Selector.Parser.LiteralLong'. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1005"'
