...
namespace CodeStreet.Selector.Parser
{
	...
	/// <summary> Class to implement conditional operators.</summary>
	/// <author>  Jawaid Hakim.
	/// </author>
	class ConditionalOp : IExpression
	{
		/// <summary> Ctor.</summary>
		/// <param name="op">Conditional operator.
		/// </param>
		/// <param name="lhs">LHS.
		/// </param>
		/// <param name="rhs">RHS.
